...
dow_url = 'https://www.alphavantage.co/query?function=TIME_SERIES_DAILY_ADJUSTED&symbol=DIA&outputsize=full&apikey=' + key
...
with open ('data/nyt_api/nyt_jsons/recent.json','w') as new_file:
